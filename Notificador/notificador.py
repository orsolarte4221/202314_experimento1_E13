...
def notificar_csv(idEjecucionValidador,fallaIntroducida,idOferta, falloHabilidad, falloPerfil, falloCalificacion, idRecursoTI, idMotor, statusMotor):
    ...
    with open('notificador.csv', 'a+') as file:
        ...
        file.write(f'{idEjecucionValidador},{fecha_hora_actual},{fallaIntroducida},{idOferta},{falloHabilidad},{falloPerfil},{falloCalificacion},{idRecursoTI},{idMotor},{statusMotor}\n')
