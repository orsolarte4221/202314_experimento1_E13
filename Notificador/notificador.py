...
def notificar_csv(fallaIntroducida,idOferta, idRecursoTI, idMotor, statusMotor):
    # Obtener la fecha y hora actual en GMT-5
    fecha_hora_actual = datetime.datetime.now()
    
    # Crear una cadena con los nombres de las columnas
    nombres_columnas = "Fecha_Hora,fallaIntroducida,IdOferta,IdRecursoTI,IdMotor,StatusMotor"
    ...
    with open('notificador.csv', 'a+') as file:
        ...
        file.write(f'{fecha_hora_actual},{fallaIntroducida},{idOferta},{idRecursoTI},{idMotor},{statusMotor}\n')
